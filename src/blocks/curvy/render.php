...
?> 
<!-- Default attributes needs to be added to style.scss file because those are not rendered until we deviate from the default attributes. - this is an open issue. --> 
